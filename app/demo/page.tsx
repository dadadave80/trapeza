...
export default function DemoPage() {
  const balances: TokenBalances = {
    ...
    eurc: MOCK.positions[1].amount,
    cirbtc: MOCK.positions[2].amount,
    prices: { usdc: 1, eurc: MOCK.prices.eurc, cirbtc: MOCK.prices.cirbtc },
    totals_usd: {
      usdc: MOCK.positions[0].usd,
      eurc: MOCK.positions[1].usd,
      cirbtc: MOCK.positions[2].usd,
    },
  ...
  const decisions = [
    ...
    ...MOCK.history.map((h) => ({
      ...
      regime: h.regime,
      target_weights: { usdc: 0.3, eurc: 0.3, cirbtc: 0.4 },
      prev_weights: null,
